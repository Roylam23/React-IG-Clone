      ...
      <div className="nav-inner">
        ...
        <div className="search-bar">
          <div className="search-inner">
            <span class="iconify" data-icon="bx:bx-search" width="10px"></span>
            <span className="search-title">搜尋</span>
          </div>
        </div>
        <div className="right-nav">
          <div className="svg-con" id="icon-1">
            <svg
              aria-label="主頁"
              class="_8-yf5 "
              fill="#ddd"
          ...
          <div className="svg-con" id="icon-2">
            <svg
          ...
          <div className="svg-con" id="icon-3">
            <svg
              aria-label="新帖子"
              class="_8-yf5 "
              fill="#ddd"
          ...
          <div className="svg-con" id="icon-4">
            <svg
              aria-label="尋找用戶"
              class="_8-yf5 "
              fill="#ddd"
          ...
          <div className="svg-con" id="icon-5">
            <svg
              aria-label="活動動態"
              class="_8-yf5 "
              fill="#ddd"
          ...
          <div className="profile-con" id="icon-6">
            <img src={icon} alt="" />
          </div>
        </div>
      </div>
